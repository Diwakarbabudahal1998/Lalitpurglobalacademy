            ...
            <div class="container">
                <div class="row page-view-row justify-content-between">
                    ...
                    <div class="about-links">
                        LGA <i class="fa fa-angle-right px-2" aria-hidden="true"></i> <span>Admission</span>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="col-md-8 col-12">
                    ...
                    <div class="admission-page">
                        ...
                        <div class="admission-criteria">
                            ...
                            <p>Admission procedure involves students&#39; ability test and parents&#39; interview.
                                Parents&#39;
                                commitment and consent is sought before the enrollment.</p>
                        </div>
                        <hr>
                        <h3>Required Documents</h3>
                        <p class="py-2"> Birth registration certificate issued by ward office, passport sized photograph,
                            Affidavit, and commitment
                            letter from parents&#39; are required to submit at the time of admission. The list of all
                        ...
                        <ul>
                            ...
                            <li><i class="far fa-check-square px-2"></i>Medical certificate (in case of any past medical
                                history)</li>
