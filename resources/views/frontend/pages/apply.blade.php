...
<hr>
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <div class="form-control" style="border:none;"><div class="form-check form-check-inline">
...
<hr>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      ...
      <div class="error text-danger">{{ $errors->first('school_address') }}</div>

    </div>
    <div class="form-group col-md-4">
      <label>Phone No.<span class="text-danger"></span></label>
      <input  type="number" min="0"name="school_phone" class="form-control {{($errors->first('school_phone') ? " form-error" : "")}}"">
      <div class="error text-danger">{{ $errors->first('school_phone') }}</div>
    ...
    <div class="form-group col-md-4">
      ...
      <div class="error text-danger">{{ $errors->first('school_board') }}</div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-3">
      ...
      <div class="error text-danger">{{ $errors->first('province') }}</div>
    ...
    <div class="form-group col-md-4">
      ...
      <div class="error text-danger">{{ $errors->first('ward_no') }}</div>
    ...
    <div class="form-group col-md-4">
      ...
      <div class="error text-danger">{{ $errors->first('street') }}</div>
  ...
  <div class="form-row">
    ...
    <hr>
    <h4>Section 4: Choose a Shift<span> ( Please Tick [✓] )</span></h4>
    <hr>
    <div class="form-row  {{($errors->first('stream') ? " form-error" : "")}}""">

<div class="form-group col-md-4 ">
  <div class="form-check form-check-inline">
  <input name="shift"class="form-check-input {{($errors->first('shift') ? " form-error" : "")}}"" type="checkbox"  value="Morning">
  <label class="form-check-label" for="inlineCheckbox1">Morning</label>
</div>
<div class="form-check form-check-inline">
  <input name="shift" class="form-check-input {{($errors->first('shift') ? " form-error" : "")}}"" type="checkbox" value="Day">
  <label class="form-check-label" for="inlineCheckbox2">Day</label>
</div>
</div>
<div class="error text-danger">{{ $errors->first('stream') }}</div>
...
<hr>
    ...
    <div class="form-row  {{($errors->first('stream') ? " form-error" : "")}}""">
          ...
          <div class="form-group col-md-3">
            <label class="px-2">Science</label>
                    <div class="form-check ">
                    <input name="stream" class="form-check-input {{($errors->first('stream') ? " form-error" : "")}}"" type="checkbox" value="Group-A (Physical)"  >
                    <label class="form-check-label" for="inlineCheckbox1">Group A (Physical)</label>
                  </div>
                    <div class="form-check">
                      <input name="stream" class="form-check-input {{($errors->first('stream') ? " form-error" : "")}}"" value="Group B (Biology)" type="checkbox" >
                      <label class="form-check-label" for="inlineCheckbox2">Group B (Biology)</label>
                    </div>
          </div>
          <div class="form-group col-md-5">
  <label class="px-2">Management</label>
          <div class="form-check ">
          <input name="stream" class="form-check-input {{($errors->first('stream') ? " form-error" : "")}}"" type="checkbox"  value="Group A (Account,B.studies & Economics/B.Math)">
          <label class="form-check-label">Group A (Account,B.studies & Economics/B.Math)</label>
        </div>
          <div class="form-check">
            <input name="stream" class="form-check-input {{($errors->first('stream') ? " form-error" : "")}}"" type="checkbox"  value="Group B (Account,B.studies/B.Math & Computer/Marketing)">
            <label class="form-check-label" >Group B (Account,B.studies/B.Math & Computer/Marketing)</label>
          </div>
          <div class="form-check">
            <input name="stream" class="form-check-input {{($errors->first('stream') ? " form-error" : "")}}"" type="checkbox"   value="Group C (Account, Travel and Mountaineering Studies & HM)">
            <label class="form-check-label">Group C (Account, Travel and Mountaineering Studies & HM)</label>
          </div>
</div>

<div class="form-group col-md-2">
                    <div class="form-check ">
                    <input name="stream" class="form-check-input {{($errors->first('stream') ? " form-error" : "")}}"" type="checkbox"value="Humanities">
          ...
          <div class="form-group col-md-2">
                    <div class="form-check ">
                    <input name="stream" class="form-check-input {{($errors->first('stream') ? " form-error" : "")}}""  type="checkbox" value="Law">
...
<div class="form-group col-md-12">
    <label><b>SEE Admit Card</b><small> ( The file must be PNG/JPEG/PDF format and less than 2MB. )</small></label>
    <input type="file"  name="see_card"  class="form-control {{($errors->first('see_card') ? " form-error" : "")}}">
    <div class="error text-danger">{{ $errors->first('see_card') }}</div>

  </div>
  <div class="form-group col-md-12">
    <label><b>SEE Grade Sheet</b><small> ( The file must be PNG/JPEG/PDF format and less than 2MB. )</small></label>
    <input type="file"  name="see_grade"  class="form-control {{($errors->first('see_grade') ? " form-error" : "")}}">
    <div class="error text-danger">{{ $errors->first('see_grade') }}</div>
