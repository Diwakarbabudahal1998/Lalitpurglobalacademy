    ...
    <div class="row">
      ...
      <div class="col-md-4 col-12  about-main-menu news-menu ">
        ...
        <ul class="list-group">
          ...
          <p> <i class="fas fa-calendar-alt py-2 px-2"></i>Starting on: {{$e->event_start}}</p>
          </li>
          @endforeach
        ...
        <div class="row  news-row">
          ...
          <div class="col-md-6 col-sm-10 col-xs-10">
            <div class="card" style="min-height:400px;">
              ...
              <div class="card-body">
                <div class="card-posted"><i class="fa fa-clock px-1 my-2"
                    aria-hidden="true"></i>{{$n->created_at->diffForHumans()}}</div>
