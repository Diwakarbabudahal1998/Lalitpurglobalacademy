                ...
                <form class="pt-5 " method="get" action="/events/search/data">
                 ...
                 <div class="filter-content">
                   <div class="list-group list-group-flush">
                     <a href="/events/category/Pre-School" class="list-group-item">Pre-School</a>
                     <a href="/events/category/Middle-School" class="list-group-item">Middle-School </a>
                     <a href="/events/category/Senior-School" class="list-group-item">Senior School </a>
                   </div>  <!-- list-group .// -->
                 </div>
                  ...
                  <li class="list-group-item">
                    ...
                    <div class="row no-gutters">
                      ...
                      <div class="col-md-8 col-sm-8 col-8">
                        <div class="card-body ">
                          <a href="/news/{{$n->id}}"><h5 class="card-title">{{$n->news_title}}</h5></a>
                    ...
                    <div class="card mt-5">
                      <div class="row no-gutters">
                        <div class="col-md-5 col-sm-12 col-xs-6">
                          <img src="{{asset('storage/'.$e->event_image)}}" style="height:200px;border:1px solid #d5d5d5;" class="card-img" alt="...">
                        </div>
                        <div class="col-md-7 col-sm-12 col-xs-6">
                          <div class="card-body" style="background:none;border:1px solid #e5e5e5">
                            ...
                            <h6 style="font-size:14px;"><i class="fas fa-calendar-alt px-2" style="color:#d3434b;"></i>{{$e->event_start}}<i class="fa ml-2 fa-clock px-1 py-2" aria-hidden="true"  style="color:#d3434b;"></i>{{$e->created_at->diffForHumans()}}</h6>
